...
export default function ExposicaoSection() {
  // Validação defensiva para evitar que a aplicação quebre se os dados estiverem vazios
  ...
  // CORREÇÃO: Usar caminho relativo direto em vez de @/ (ajuste os '../' conforme a pasta onde este componente está)
  // Exemplo: se este ficheiro está em src/components/, usamos '../assets/...'
